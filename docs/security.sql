...
insert  into `sys_permission`(`id`,`name`,`description`,`url`,`pid`) values (3,'ADMIN','','',NULL),(4,'USER','','',NULL);
...
insert  into `sys_user`(`id`,`name`,`password`) values (2,'admin','admin'),(3,'zhouhu','123456');
